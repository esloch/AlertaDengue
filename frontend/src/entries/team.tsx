...
const propsElement = document.getElementById("team-page-props");
const rootElement = document.getElementById("team-react-root");
...
function TeamPage({ hero, sections, contact }: TeamPageProps) {
  return (
...
if (rootElement && propsElement?.textContent) {
  const props = JSON.parse(propsElement.textContent) as TeamPageProps;
  createRoot(rootElement).render(<TeamPage {...props} />);
}
